...
nv.models.stackedAreaChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var marginn = {top: 30, right: 30, bottom: 30, left: 30},
    availableWidth = (window.innerWidth*.91) - marginn.left - marginn.right,
    availableHeight = 500 - marginn.top - marginn.bottom;
    margin.left = 30;
